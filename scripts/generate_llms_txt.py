...
def render_llms_txt(data: dict, classif: dict) -> str:
    ...
    parts.append(f"- [Build Mechanics]({SITE}/build-mechanics.html): operational layer — BAU vs floor sweeps, the cat 1/2/3 estate-maturity model (with a 1/3-1/3-1/3 worked example), WAFs as spackle, and how filter value depends on response shape")
